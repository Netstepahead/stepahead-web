...
const translations: Record<Language, Record<string, string>> = {
  ...
  he: {
    ...
    'index.pillar1.text': 'פיתוח \'תפיסת רשת\' אצל מנהלים. אנו משלבים מודלים אסטרטגיים עם סימולציות מתקדמות המשמשות כ\'סימולטור טיסה\' ניהולי, כדי להקנות כלים להובלה מתוך השפעה, פירוק סיילואים וניווט במורכבות הארגונית.',
