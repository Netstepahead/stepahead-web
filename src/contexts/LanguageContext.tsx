...
const translations: Record<Language, Record<string, string>> = {
  ...
  he: {
    ...
    'about.dataIntuitionDesc': 'אנו מאמינים בתחושות בטן, אבל סומכים על דאטה. אנו הופכים את הבלתי-נראה לנראה.',
    'about.peopleFirst': 'אנשים לפני הכל',
    'about.peopleFirstDesc': 'צמתים וקווים זה מעניין, אבל בסוף מערכות יחסים אנושיות הן הדבר האמיתי.',
    'about.actionableInsights': 'תובנות לפעולה',
    'about.actionableDesc': 'אנחנו לא מסתפקים במיפוי הבעיה; אנחנו מכוונים אתכם לפתרון.',
