...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'platform.title': 'From Organizational Insights to Personal Impact',
    'platform.subtitle': 'We combine advanced network mapping for leadership with a personal AI assistant for your employees—creating a fully connected organization from the bottom up.',
    'platform.onaEngine': 'Organizational Network Analysis (ONA)',
    'platform.visualizeInvisible': 'The Macro View: Map the Reality',
    ...
    'platform.collabAgent': 'The Personal Collab Agent',
    'platform.actionableNudges': 'The Micro View: Empower the End-User',
    'platform.agentDesc': "We shift the power from the organizational view to the personal view. The Collab Agent lives directly in your employees' workflow (Teams/Slack), acting as their private networking assistant to help them navigate the company.",
    'platform.agentFeature1': 'Direct access for end-users and managers',
    'platform.agentFeature2': 'Seamless workflow integration',
    'platform.agentFeature3': 'Privacy-first, personal networking assistance',
    'platform.networkProfiling': 'Personal Profiling & Connections',
    'platform.deepInsight': 'Solve Daily Challenges Faster',
    'platform.profilingDesc': 'Through the Agent interface, users discover their own "Network Persona." When an employee faces a challenge, the Agent instantly suggests the exact, non-obvious people they should connect with to solve it.',
    'platform.profilingFeature1': 'Discover your personal network skills/role',
    'platform.profilingFeature2': 'Context-aware connection recommendations',
    'platform.profilingFeature3': 'Break down silos through peer-to-peer collaboration',
  ...
  he: {
    ...
    'platform.title': 'מתובנות ארגוניות להשפעה אישית',
    'platform.subtitle': 'אנו משלבים מיפוי רשת מתקדם להנהלה יחד עם סוכן AI אישי לעובדים—כדי לייצר ארגון מחובר לחלוטין, מלמטה למעלה.',
    'platform.onaEngine': 'ניתוח רשתות ארגוניות (ONA)',
    'platform.visualizeInvisible': 'מבט המאקרו: למפות את המציאות',
    ...
    'platform.collabAgent': 'סוכן ה-Collab האישי',
    'platform.actionableNudges': 'מבט המיקרו: העצמת העובד בקצה',
    'platform.agentDesc': 'אנו מעבירים את הכוח מהמבט הארגוני אל המבט האישי. הסוכן שלנו חי ישירות בסביבת העבודה של העובד (Teams/Slack), ומשמש כעוזר רישות אישי שמסייע לו לנווט בארגון.',
    'platform.agentFeature1': 'גישה ישירה לעובדים ולמנהלים',
    'platform.agentFeature2': 'אינטגרציה חלקה לסביבת העבודה היומיומית',
    'platform.agentFeature3': 'עוזר אישי פרטי לשיתופי פעולה',
    'platform.networkProfiling': 'פרופיל אישי וחיבורים חכמים',
    'platform.deepInsight': 'לפתור אתגרי עבודה מהר יותר',
    'platform.profilingDesc': 'דרך ממשק הסוכן, העובדים מגלים את ה"פרסונה הרשתית" שלהם. כשעובד נתקל באתגר, הסוכן מציע לו בזמן אמת את האנשים המדויקים (והלא-מובנים מאליהם) שכדאי לו לדבר איתם.',
    'platform.profilingFeature1': 'גילוי תפקיד וכישורי הרשת האישיים',
    'platform.profilingFeature2': 'המלצות לחיבורים מבוססות-הקשר',
    'platform.profilingFeature3': 'פירוק סיילואים דרך חיבורים אישיים',
