...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Assessment
    'assessment.badge': 'TALENT SELECTION & ASSESSMENT',
    'assessment.title': 'Hire for the Network, Not Just the Role',
    'assessment.subtitle': 'Traditional interviews only tell half the story. Use game-based cognitive assessments to uncover how candidates actually think, adapt, and solve problems.',
    'assessment.beyondCv': 'BEYOND THE RESUME',
    'assessment.beyondCvTitle': 'Measure What Actually Matters',
    'assessment.beyondCvDesc': 'A CV tells you what a candidate has done. Our game-based assessments tell you how they will perform. We measure cognitive flexibility, resilience, and strategic thinking in a dynamic, stress-tested environment to ensure they fit your organizational network.',
    'assessment.feature1': 'Unbiased, data-driven candidate profiles',
    'assessment.feature2': 'Highly engaging, gamified candidate experience',
    'assessment.feature3': 'Predictive analytics for cultural and network fit',
    'assessment.whatWeMeasure': 'Core Capabilities Evaluated',
    'assessment.measure1Title': 'Cognitive Flexibility',
    'assessment.measure1Desc': 'How quickly can they adapt to changing rules, shifting environments, and new information?',
    'assessment.measure2Title': 'Strategic Problem Solving',
    'assessment.measure2Desc': 'How do they analyze complex situations, identify patterns, and execute long-term solutions?',
    'assessment.measure3Title': 'Decision Making Under Pressure',
    'assessment.measure3Desc': 'How effectively do they balance risks, manage limited resources, and time their actions?',
    'assessment.ctaTitle': 'Upgrade Your Hiring Process',
    'assessment.ctaDesc': 'Stop guessing. Start measuring the actual skills needed to build an agile, connected organization.',
    'assessment.ctaButton': 'Request an Assessment Demo',
  ...
  he: {
    ...
    // Assessment
    'assessment.badge': 'איתור והערכת טאלנטים',
    'assessment.title': 'לגייס עבור הרשת, לא רק עבור התפקיד',
    'assessment.subtitle': 'ראיונות מסורתיים מספרים רק חצי מהסיפור. השתמשו בהערכות קוגניטיביות מבוססות-משחק כדי לחשוף איך מועמדים באמת חושבים, מסתגלים ופותרי בעיות.',
    'assessment.beyondCv': 'מעבר לקורות החיים',
    'assessment.beyondCvTitle': 'למדוד את מה שבאמת חשוב',
    'assessment.beyondCvDesc': 'קורות חיים מספרים לכם מה המועמד עשה בעבר. ההערכות מבוססות-המשחק שלנו מראות לכם איך הוא יתפקד בזמן אמת. אנו מודדים גמישות מחשבתית, חוסן וחשיבה אסטרטגית בסביבה דינמית, כדי לוודא התאמה מושלמת לרשת הארגונית שלכם.',
    'assessment.feature1': 'פרופיל מועמד חף מהטיות ומבוסס נתונים',
    'assessment.feature2': 'חווית מועמד משחקית, חדשנית ומרתקת',
    'assessment.feature3': 'יכולת ניבוי להתאמה תרבותית ורשתית',
    'assessment.whatWeMeasure': 'היכולות המרכזיות שאנו מעריכים',
    'assessment.measure1Title': 'גמישות קוגניטיבית',
    'assessment.measure1Desc': 'באיזו מהירות הם מסתגלים לחוקים משתנים, סביבות חדשות ומידע לא צפוי?',
    'assessment.measure2Title': 'פתרון בעיות אסטרטגי',
    'assessment.measure2Desc': 'איך הם מנתחים מצבים מורכבים, מזהים תבניות ומוציאים לפועל פתרונות ארוכי טווח?',
    'assessment.measure3Title': 'קבלת החלטות תחת לחץ',
    'assessment.measure3Desc': 'עד כמה הם יעילים באיזון סיכונים, ניהול משאבים מוגבלים ותזמון הפעולות שלהם?',
    'assessment.ctaTitle': 'שדרגו את תהליך הגיוס שלכם',
    'assessment.ctaDesc': 'הפסיקו לנחש. התחילו למדוד את הכישורים האמיתיים שדרושים לבניית ארגון אג\'ילי ומחובר.',
    'assessment.ctaButton': 'קבעו פגישת ייעוץ',
