...
const HeroSection = () => {
  ...
  return (
    <section className="relative bg-[#FAF9F6] overflow-hidden flex flex-col justify-start min-h-screen">
      ...
      {/* ריווח עליון (pt-32) כדי שהתפריט לא יסתיר את התוכן */}
      <div className="container mx-auto px-4 relative z-10 flex-grow flex flex-col justify-center pt-32 pb-20">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          
          {/* צד שמאל: טקסט */}
          <div className="lg:w-1/2 text-left space-y-8 animate-fade-up">
            
            {/* הורדנו מפה את הלוגו הכפול */}
