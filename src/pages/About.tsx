    ...
    <div className="w-full bg-white" dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <section className="py-16 md:py-24 bg-slate-50">
        <div className="container mx-auto px-4 md:px-6 text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-[#1B365D] mb-6 leading-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 max-w-6xl mx-auto">
            {leadership.map((member, i) => (
              <div key={i} className="flex flex-col items-center text-center">
                <div className="aspect-square w-full max-w-[280px] overflow-hidden rounded-xl mb-6 bg-white/10">
                  <img
                    src={member.image}
                    alt={member.name}
